...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('user.dataadmin.home')}}" class="nav-link">Home</a>
        </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="{{ route('user.dataadmin.edit',['id'=>Auth::guard('emp')->user()->id, 'v'=>'data admin'])}}" class="dropdown-item">
                    <i class="fas fa-user"></i></i> View Profile
                </a>
                <div class="dropdown-divider"></div>
...
<!-- <div id="dadmin-profile" class="modal">
      <div class="card mt-3">
        ...
        <div class="card-body colorDesign">         
            ...
            <form action="{{ url('data-admin-update')}}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="row">
                    <div class="col-md-6">
